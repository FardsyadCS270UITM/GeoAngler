...
import com.hemantpatel.mpfapp.Searchlens;
...
public class MissingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FloatingActionButton fabSearch = mView.findViewById(R.id.fab_search);
        fabSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Perform the navigation to the Searchlens activity
                Intent intent = new Intent(getActivity(), Searchlens.class);
