...
public class MissingListAdapter extends RecyclerView.Adapter<MissingListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.mAge.setText(String.format("Weight(kg): %s", data.getAge()));
        holder.mGender.setText(String.format("Habitat: %s", data.getGender()));
        holder.mMissingDate.setText(String.format("Date : %s", data.getMissing_date()));
        holder.mPrize.setText(String.format("Price: %s", mList.get(position).getPrize()));
