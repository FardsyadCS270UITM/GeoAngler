...
public class MissingPersonDetailActivity extends AppCompatActivity {
    ...
    public void initViews() {
        ...
        age.setText(String.format("Weight(kg): %s", mPersonData.getAge()));
        gender.setText(String.format("Habitat: %s", mPersonData.getGender()));
        missing_date.setText(String.format("Date: %s", mPersonData.getMissing_date()));
